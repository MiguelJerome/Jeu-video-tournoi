 ...
 */
let inputPrenomUtilisateur = document.getElementById(
  "input-prenom-utilisateur"
);
let errorPrenomUtilisateur = document.getElementById(
  "error-prenom-authentification"
);
...
formInscription.addEventListener("submit", async (event) => {
  ...
  if (
    ...
    if (response.ok) {
      ...
      p.innerText = "Ce Couriel existe deja";
      p.style.color = "red";
      formInscription.append(p);
    } else {
